...
_GLIBCXX_BEGIN_NAMESPACE_CXX11
  ...
  public:
    ...
    directory_iterator(const directory_iterator& __rhs) = delete;

    directory_iterator(directory_iterator&& __rhs) noexcept;

    ~directory_iterator();

    directory_iterator&
    operator=(const directory_iterator& __rhs) = delete;

    directory_iterator&
    operator=(directory_iterator&& __rhs) noexcept;
  ...
  public:
    ...
    recursive_directory_iterator(
        const recursive_directory_iterator&) = delete;
    ...
    // modifiers
    recursive_directory_iterator&
    operator=(const recursive_directory_iterator& __rhs) noexcept = delete;
    recursive_directory_iterator&
  ...
  private:
    ...
    struct _Dir_stack;
    std::unique_ptr<_Dir_stack> _M_dirs;
